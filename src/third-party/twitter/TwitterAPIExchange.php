...
class TwitterAPIExchange
{
    ...
    public function performRequest($return = true, $curlOptions = array())
    {
        ...
        # Proper fix for certificate issues
        curl_setopt($feed, CURLOPT_SSL_VERIFYPEER, true);
        curl_setopt($feed, CURLOPT_SSL_VERIFYHOST, 2);

        # better fix for certificate error
        curl_setopt($feed, CURLOPT_CAINFO, __DIR__."/cacert.pem");
